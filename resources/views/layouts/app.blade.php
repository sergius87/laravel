...
<head>
    ...
    <link rel="stylesheet" href="{{ public_path() }}/assets/css/headers/header-default.css">
    <link rel="stylesheet" href="{{ public_path() }}/assets/css/footers/footer-v1.css">

    <!-- CSS Implementing Plugins -->
    <link rel="stylesheet" href="{{ public_path() }}/assets/plugins/animate.css">
    <link rel="stylesheet" href="{{ public_path() }}/assets/plugins/line-icons/line-icons.css">
    <link rel="stylesheet" href="{{ public_path() }}/assets/plugins/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{ public_path() }}/assets/plugins/parallax-slider/css/parallax-slider.css">
    <link rel="stylesheet" href="{{ public_path() }}/assets/plugins/owl-carousel/owl-carousel/owl.carousel.css">

    <!-- CSS Theme -->
    <link rel="stylesheet" href="{{ public_path() }}/assets/css/theme-colors/default.css" id="style_color">
    <link rel="stylesheet" href="{{ public_path() }}/assets/css/theme-skins/dark.css">
...
<body>
        ...
        <div class="header">
            <div class="container">
                ...
                <a class="logo" href="{{ URL::route('home') }}">
                    <img src="{{ public_path() }}/assets/img/logo1-default.png" alt="Logo">
                </a>
                <!-- End Logo -->
    ...
    <script type="text/javascript" src="{{ public_path() }}/assets/plugins/jquery/jquery.min.js"></script>
    <script type="text/javascript" src="{{ public_path() }}/assets/plugins/jquery/jquery-migrate.min.js"></script>
    <script type="text/javascript" src="{{ public_path() }}/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
    <!-- JS Implementing Plugins -->
    <script type="text/javascript" src="{{ public_path() }}/assets/plugins/back-to-top.js"></script>
    <script type="text/javascript" src="{{ public_path() }}/assets/plugins/smoothScroll.js"></script>
    <script type="text/javascript" src="{{ public_path() }}/assets/plugins/parallax-slider/js/modernizr.js"></script>
    <script type="text/javascript" src="{{ public_path() }}/assets/plugins/parallax-slider/js/jquery.cslider.js"></script>
    <script type="text/javascript" src="{{ public_path() }}/assets/plugins/owl-carousel/owl-carousel/owl.carousel.js"></script>
    <!-- JS Customization -->
    <script type="text/javascript" src="{{ public_path() }}/assets/js/custom.js"></script>
    <!-- JS Page Level -->
    <script type="text/javascript" src="{{ public_path() }}/assets/js/app.js"></script>
    <script type="text/javascript" src="{{ public_path() }}/assets/js/plugins/owl-carousel.js"></script>
    <script type="text/javascript" src="{{ public_path() }}/assets/js/plugins/style-switcher.js"></script>
    <script type="text/javascript" src="{{ public_path() }}/assets/js/plugins/parallax-slider.js"></script>
